...
In addition to the atrocities committed by Christians upon Christians, the heavily wounded  could no longer provide a real defense against the Islamic states
